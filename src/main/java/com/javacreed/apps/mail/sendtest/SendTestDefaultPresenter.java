 ...
 * #L%
 */
package com.javacreed.apps.mail.sendtest;
...
import com.javacreed.apps.mail.Email;
import com.javacreed.apps.mail.Model;
import com.javacreed.apps.mail.SendMailWorker;
import com.javacreed.apps.mail.SwingUtils;
...
public class SendTestDefaultPresenter implements SendTestPresenter {
  ...
  public void onClosing() {
    if (!sendAction.isEnabled()) {
      view.showWarn("Closing", "Please wait for the test email to be sent before closing this dialog");
      return;
    }
    close();
  }
